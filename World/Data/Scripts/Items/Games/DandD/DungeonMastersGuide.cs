    ...
    public class DungeonMastersGuide : Item
	{
		...
		public class DMGuideGump : Gump
		{
			public DMGuideGump( Mobile from ): base( 50, 50 )
			{
				...
				AddHtml( 15, 50, 675, 20, @"<BODY><BASEFONT Color=#DC7676>This book contains a listing of almost all of the dungeons in the " + MySettings.S_ServerName + ".</BASEFONT></BODY>", (bool)false, (bool)false);
			}
