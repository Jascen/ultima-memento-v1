		...
		public static Item RandomItem( Mobile m, int level )
		{
			...
			else
			{
				switch ( var ) 
				{
					...
					case 1:
					case 2:
					case 3: item = RandomSciFi(); break;
					case 4: item = RandomFoods( false, false ); break;
					case 5: item = RandomPossibleReagent(); break;
					case 6: item = RandomBooks( Utility.Random(4)+1 ); break;
					case 7: item = RandomProvisions(); break;
					case 8:
						switch ( Utility.Random(4) ) 
						{
							case 0: item = RandomJunk(); break;
							case 1: item = RandomCoins( m ); break;
