	...
	public class LearnTailorBook : Item
	{
		...
		public class LearnTailorGump : Gump
		{
			public LearnTailorGump( Mobile from ): base( 50, 50 )
			{
				...
				AddHtml( 15, 49, 573, 333, @"<BODY><BASEFONT Color=" + color + ">You can sheer sheep with a bladed weapon to get wool by double clicking the weapon and then targeting the sheep. You can also find gardens that grow cotton and flax. You can gather these by double clicking the plants and then the plants will be placed in your pack. Once gathered, you can use them on a spinning wheel to make yarn and spools of string.<br><br>Once you have the yarn or thread, you can use those on a loom to make bolts of cloth by double clicking the spool or thread and then selecting the loom. Taking scissors to these bolts of cloth will produce cut cloth that you can then use with a sewing kit to make clothing. You can also cut the cloth down further into bandages if you need them. Cutting folded cloth will also create bandages. If you wish to fold up the cut cloth, simply double click the cut cloth and it will be folded. Both cut and folded cloth can be used in tailoring items.</BASEFONT></BODY>", (bool)false, (bool)false);
