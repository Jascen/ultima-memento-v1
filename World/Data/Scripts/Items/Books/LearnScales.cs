	...
	public class LearnScalesBook : Item
	{
		...
		public class LearnScalesGump : Gump
		{
			public LearnScalesGump( Mobile from ): base( 50, 50 )
			{
				...
				AddHtml( 65, 425, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Crimson</BASEFONT></BODY>", (bool)false, (bool)false);
				AddItem(20, 455, 9905, 0x8A8);
				AddHtml( 65, 455, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Golden</BASEFONT></BODY>", (bool)false, (bool)false);

				AddItem(240, 425, 9905, 0x455);
				AddHtml( 285, 425, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Dark</BASEFONT></BODY>", (bool)false, (bool)false);
				AddItem(240, 455, 9905, 0x851);
				AddHtml( 285, 455, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Viridian</BASEFONT></BODY>", (bool)false, (bool)false);
				AddItem(240, 485, 9905, 0x8FD);
				AddHtml( 285, 485, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Ivory</BASEFONT></BODY>", (bool)false, (bool)false);

				AddItem(440, 425, 9905, 0x8B0);
				AddHtml( 485, 425, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Azure</BASEFONT></BODY>", (bool)false, (bool)false);
