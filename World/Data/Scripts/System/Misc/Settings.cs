...
namespace Server
{
    class MyServerSettings
    {
		...
		{
			if ( Utility.DateUpdated() != 20240303 )
		...
		public static int QuestRewardModifier()
		{
			...
			if ( MySettings.S_QuestRewardModifier < 50 ){ MySettings.S_QuestRewardModifier = 50; } else if ( MySettings.S_QuestRewardModifier > 250 ){ MySettings.S_QuestRewardModifier = 250; }
