...
namespace Server
{
	public class SpawnList
	{
		...
		private static Type[] FieldAnimals = new Type[]
		{
			...
			typeof( Worg ),					typeof( Ridgeback ),			typeof( Ferret ),
			typeof( DireGoat ),				typeof( Mastadon ),				typeof( RidableLlama )
		};
		...
		{
			typeof( Jackal ),				typeof( Weasel ),				typeof( JackRabbit ),
			typeof( Bobcat ),				typeof( Antelope ),				typeof( DesertOstard )
		};

		private static Type[] SwampAnimals = new Type[]
		{
			typeof( Boar ),					typeof( Bull ),					typeof( BlackBear ),
			typeof( Turtle ),				typeof( Frog ),					typeof( Rat ),		
		...
		{
			typeof( Boar ),					typeof( BlackBear ),			typeof( Rat ),
			typeof( BlackWolf )
		};
		...
		private static Type[] Forest_A = new Type[]
		{
			...
			typeof( Snake ),				typeof( GiantLizard ),			typeof( LargeSnake ),
		...
		private static Type[] Jungle_A = new Type[]
		{
			...
			typeof( Snake ),				typeof( SkeletonArcher ),		typeof( Skeleton ),
