		...
		public DeathKnightSpellbookGump( Mobile from, DeathKnightSpellbook book, int page ) : base( 100, 100 ) 
		{
			...
			else
			{
				...
				if ( page == 2 )
				{
					...
					skil1 = "40";
					mana1 = "36";
					text1 = ""; if ( !this.HasSpell( from, 750) ){ z1=220; text1 = "Saint Kargoth<BR>Land of Sosaria: Ancient Pyramid<BR>" + sGrave + "<BR><BR>"; }
					...
					skil2 = "15";
					mana2 = "16";
					text2 = ""; if ( !this.HasSpell( from, 751) ){ z2=220; text2 = "Lord Monduiz Dephaar<BR>Land of Sosaria: Dungeon Clues<BR>" + sGrave + "<BR><BR>"; }
				...
				else if ( page == 3 )
				{
					...
					skil1 = "90";
					mana1 = "60";
					text1 = ""; if ( !this.HasSpell( from, 752) ){ z1=220; text1 = "Lady Kath of Naelex<BR>Land of Sosaria: Dungeon Doom<BR>" + sGrave + "<BR><BR>"; }
					...
					skil2 = "30";
					mana2 = "28";
					text2 = ""; if ( !this.HasSpell( from, 753) ){ z2=220; text2 = "Prince Myrhal of Rax<BR>Land of Sosaria: Fires of Hell<BR>" + sGrave + "<BR><BR>"; }
				...
				else if ( page == 4 )
				{
					...
					skil1 = "5";
					mana1 = "8";
					text1 = ""; if ( !this.HasSpell( from, 754) ){ z1=220; text1 = "Sir Maeril of Naelax<BR>Land of Sosaria: Dungeon Exodus<BR>" + sGrave + "<BR><BR>"; }
					...
					skil2 = "70";
					mana2 = "52";
					text2 = ""; if ( !this.HasSpell( from, 755) ){ z2=220; text2 = "Sir Farian of Lirtham<BR>Land of Ambrosia: City of the Dead<BR>" + sGrave + "<BR><BR>"; }
				...
				else if ( page == 5 )
				{
					...
					skil1 = "25";
					mana1 = "24";
					text1 = ""; if ( !this.HasSpell( from, 756) ){ z1=220; text1 = "Lord Androma of Gara<BR>Island of Umber Veil: the Mausoleum<BR>" + sGrave + "<BR><BR>"; }
					...
					skil2 = "80";
					mana2 = "56";
					text2 = ""; if ( !this.HasSpell( from, 757) ){ z2=220; text2 = "Sir Oslan Knarren<BR>Land of Lodoria: Dungeon Despise<BR>" + sGrave + "<BR><BR>"; }
				...
				else if ( page == 6 )
				{
					...
					skil1 = "60";
					mana1 = "48";
					text1 = ""; if ( !this.HasSpell( from, 758) ){ z1=220; text1 = "Sir Rezinar of Haxx<BR>Land of Lodoria: Dungeon Deceit<BR>" + sGrave + "<BR><BR>"; }
					...
					skil2 = "45";
					mana2 = "40";
					text2 = ""; if ( !this.HasSpell( from, 759) ){ z2=220; text2 = "Lord Thyrian of Naelax<BR>Land of Lodoria: Dungeon Wrong<BR>" + sGrave + "<BR><BR>"; }
				...
				else if ( page == 7 )
				{
					...
					skil1 = "20";
					mana1 = "20";
					text1 = ""; if ( !this.HasSpell( from, 760) ){ z1=220; text1 = "Sir Minar of Darmen<BR>Land of Lodoria: Lodoria Catacombs<BR>" + sGrave + "<BR><BR>"; }
					...
					skil2 = "10";
					mana2 = "12";
					text2 = ""; if ( !this.HasSpell( from, 761) ){ z2=220; text2 = "Duke Urkar of Torquann<BR>Land of Lodoria: Dungeon Shame<BR>" + sGrave + "<BR><BR>"; }
				...
				else if ( page == 8 )
				{
					...
					skil1 = "35";
					mana1 = "32";
					text1 = ""; if ( !this.HasSpell( from, 762) ){ z1=220; text1 = "Sir Luren the Boar<BR>Land of Lodoria: the City of Embers<BR>" + sGrave + "<BR><BR>"; }
					...
					skil2 = "50";
					mana2 = "44";
					text2 = ""; if ( !this.HasSpell( from, 763) ){ z2=220; text2 = "Lord Khayven of Rax<BR>Land of Lodoria: Dungeon Hythloth<BR>" + sGrave + "<BR><BR>"; }
