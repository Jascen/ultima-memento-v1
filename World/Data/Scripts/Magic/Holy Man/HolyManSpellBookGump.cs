		...
		public HolyManSpellbookGump( Mobile from, HolyManSpellbook book, int page ) : base( 100, 100 ) 
		{
			...
			else
			{
				...
				if ( page == 2 )
				{
					...
					skil1 = "60";
					mana1 = "30";
					text1 = ""; if ( !this.HasSpell( from, 770) ){ z1=220; text1 = "Patriarch Morden rests south of the Village of Springvale<br><br>Mantra: exilium<BR><BR>"; }
					...
					skil2 = "70";
					mana2 = "35";
					text2 = ""; if ( !this.HasSpell( from, 771) ){ z2=220; text2 = "Archbishop Halyrn rests by the Village of Whisper<br><br>Mantra: accipe spiritum<BR><BR>"; }
				...
				else if ( page == 3 )
				{
					...
					skil1 = "90";
					mana1 = "45";
					text1 = ""; if ( !this.HasSpell( from, 772) ){ z1=220; text1 = "Bishop Leantre rests in the Kuldar Cemetery<br><br>Mantra: fascinare<BR><BR>"; }
					...
					skil2 = "50";
					mana2 = "25";
					text2 = ""; if ( !this.HasSpell( from, 773) ){ z2=220; text2 = "Deacon Wilems rests in the City of Elidor<br><br>Mantra: malleo fidei<BR><BR>"; }
				...
				else if ( page == 4 )
				{
					...
					skil1 = "10";
					mana1 = "5";
					text1 = ""; if ( !this.HasSpell( from, 774) ){ z1=220; text1 = "Drumat the Apostle rests by the City of Britain<br><br>Mantra: caelesti lumine<BR><BR>"; }
					...
					skil2 = "10";
					mana2 = "5";
					text2 = ""; if ( !this.HasSpell( from, 775) ){ z2=220; text2 = "Vincent the Priest rests by the Town of Moon<br><br>Mantra: famem prohibere<BR><BR>"; }
				...
				else if ( page == 5 )
				{
					...
					skil1 = "40";
					mana1 = "20";
					text1 = ""; if ( !this.HasSpell( from, 776) ){ z1=220; text1 = "Abigayl the Preacher rests near the Church of the Divine in the Town of Renika<br><br>Mantra: deiectionem<BR><BR>"; }
					...
					skil2 = "80";
					mana2 = "40";
					text2 = ""; if ( !this.HasSpell( from, 777) ){ z2=220; text2 = "Cardinal Greggs rests near the Greensky Village<br><br>Mantra: reditus vitae<BR><BR>"; }
				...
				else if ( page == 6 )
				{
					...
					skil1 = "20";
					mana1 = "10";
					text1 = ""; if ( !this.HasSpell( from, 778) ){ z1=220; text1 = "Father Michal rests by the Village of Grey<br><br>Mantra: sacrum munus<BR><BR>"; }
					...
					skil2 = "30";
					mana2 = "15";
					text2 = ""; if ( !this.HasSpell( from, 779) ){ z2=220; text2 = "Sister Tiana rests south of the City of Montor<br><br>Mantra: benedicite<BR><BR>"; }
				...
				else if ( page == 7 )
				{
					...
					skil1 = "60";
					mana1 = "30";
					text1 = ""; if ( !this.HasSpell( from, 780) ){ z1=220; text1 = "Brother Kurklan rests near the Village of Islegem<br><br>Mantra: spiritus mundi<BR><BR>"; }
					...
					skil2 = "40";
					mana2 = "20";
					text2 = ""; if ( !this.HasSpell( from, 781) ){ z2=220; text2 = "Edwin the Pope rests in the Lodoria Cemetery<br><br>Mantra: percutiat<BR><BR>"; }
				...
				else if ( page == 8 )
				{
					...
					skil1 = "20";
					mana1 = "10";
					text1 = ""; if ( !this.HasSpell( from, 782) ){ z1=220; text1 = "Xephyn the Monk rests near the Town of Devil Guard<br><br>Mantra: tactus vitae<BR><BR>"; }
					...
					skil2 = "30";
					mana2 = "15";
					text2 = ""; if ( !this.HasSpell( from, 783) ){ z2=220; text2 = "Chancellor Davis rests on an island near the Village of Fawn<br><br>Mantra: igne iudicii<BR><BR>"; }
