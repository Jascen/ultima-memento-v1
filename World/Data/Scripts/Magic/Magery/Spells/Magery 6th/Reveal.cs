		...
		public void Target( IPoint3D p )
		{
			...
			else if ( CheckSequence() )
			{
				...
				foreach ( Item item in TitemsInRange )
				{
					...
					{
						string where = Worlds.GetRegionName( Caster.Map, Caster.Location );
						...
						else if ( level > 4 )
						{
							...
							Effects.SendLocationParticles( EffectItem.Create( mBox.Location, mBox.Map, EffectItem.DefaultDuration ), 0x376A, 9, 32, PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0, 5024, 0 );
						...
						else
						{
							...
							Effects.SendLocationParticles( EffectItem.Create( coins.Location, coins.Map, EffectItem.DefaultDuration ), 0x376A, 9, 32, PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0, 5024, 0 );
