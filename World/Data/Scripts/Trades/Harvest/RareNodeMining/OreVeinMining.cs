...
{
    public class OreVeinMining : Mining
    {
        ...
        private static OreVeinMining m_System;

        private readonly HarvestDefinition m_rareNodeDefinition;

        private OreVeinMining()
        {
        ...
        public new static OreVeinMining System
        {
            get
            {
                if (m_System == null)
                    m_System = new OreVeinMining();
        ...
        {
            if (toHarvest is OreVeinMineable)
            {
                OreVeinMineable obj = (OreVeinMineable)toHarvest;
                tileID = obj.ItemID;
                map = from.Map;
                loc = obj.Location;
        ...
        public override void OnHarvestFinished(Mobile from, Item tool, HarvestDefinition def, HarvestVein vein, HarvestBank bank, HarvestResource resource, object harvested)
        {
            ...
            if (harvested is OreVeinMineable)
            {
                OreVeinMineable obj = (OreVeinMineable)harvested;
                if (bank.Current < 1)
                {
                    obj.Delete();
                }
