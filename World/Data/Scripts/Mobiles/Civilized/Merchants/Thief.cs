	...
	public class Thief : BaseVendor
	{
		...
		public class MyStock: SBInfo
		{
			...
			public class InternalBuyInfo : List<GenericBuyInfo>
			{
				...
				{
					ItemInformation.GetSellList( m_Merchant, this, 	ItemSalesInfo.Category.All,			ItemSalesInfo.Material.None,		ItemSalesInfo.Market.Thief,		ItemSalesInfo.World.None,	null	 );
			...
			public class InternalSellInfo : GenericSellInfo
			{
				...
				{
					ItemInformation.GetBuysList( m_Merchant, this, 	ItemSalesInfo.Category.All,			ItemSalesInfo.Material.None,		ItemSalesInfo.Market.Thief,		ItemSalesInfo.World.None,	null	 );
